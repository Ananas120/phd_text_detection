...
import eval_protocols.rrc_evaluation_funcs_1_1 as rrc_evaluation_funcs
import importlib
...
def DetEval_results(model_name):
    p = {
      "g" : "/content/drive/MyDrive/Thesis/SSD/eval_protocols/gt.zip",
      "s" : "/content/drive/MyDrive/Thesis/SSD/eval_protocols/" + model_name + ".zip"
    }
